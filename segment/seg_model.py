...
class ARC_Task():
    ...
    def _build(self):
        ...
        feature = kl.Conv2D(100, kernel_size = (3, 3), activation = 'relu',
                              strides = (1, 1), padding = 'same', name = 'conv3')(feature) 
        feature = kl.BatchNormalization(name = 'bn3')(feature)  
        ...
        output = self.fit = Fit(pool_len = self.pool_len, k_shape = (3, 3, 100, 1),\
