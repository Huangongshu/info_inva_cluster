...
class BaseModel():
    def __init__(self, input_shapes, trainable = True):
        ...
        x = kl.Conv2D(32, (3, 3), strides = (2, 2), name = 'conv1_conv',
                   padding = 'same',      
                   # kernel_initializer = ki.Ones(),
                   kernel_initializer = ki.he_normal(),                
                   bias_initializer = ki.Zeros(),
        ...
        x = conv_block(x, 3, [64, 64, 256], stage = 2, num_block = '1', strides = (2, 2), trainable = self.trainable)
        ...
        x = kl.UpSampling2D(size = (4, 4), interpolation='bilinear')(x)
